// ================================================================================
// dpx_font.h — AwtrixFont (TomThumb-derived 3x5 pixel font)
// ================================================================================
//
// License: BSD 3-Clause (see full text below)
//
// Original 3x5 font: Brian J. Swetland, Vassilii Khachaturov (1999)
// TomThumb modifications: Robey Pointer (2010) — http://robey.lag.net/2010/01/23/tiny-monospace-font.html
// AWTRIX modifications for improved readability: Blueforcer (2018–2024)
// GFX conversion: William Skellenger (2016)
//
// Redistributed under the BSD 3-Clause License. Attribution retained above.
// See: http://opengameart.org/forumtopic/how-to-submit-art-using-the-3-clause-bsd-license
//
// ================================================================================
...
//
// File: dpx_font.h
// Purpose: Inline GFX-format font data + lightweight lookup helpers.
//          Used by dpx_text.h for rendering text onto the 32x8 LED matrix.
//
// Font metrics (per glyph, all glyphs):
//   Height:    5 pixels (yOffset = -5 from baseline)
//   yAdvance:  6 (line height; only 1 row used currently)
//   Baseline:  set cursor_y = DPX_FONT_BASELINE (= 6) to center in 8-row display
//              → glyph rows land on matrix rows 1..5, leaving row 0 and rows 6..7 clear
//   xAdvance:  variable (2..4 px) includes 1-px right gap
//
// ================================================================================

#pragma once

// ── Adafruit GFX font structs (defined here; WLED does not bundle Adafruit GFX) ──
#ifndef _GFXFONT_H_
#define _GFXFONT_H_
typedef struct {
    ...
    int8_t   yOffset;      // Y dist from cursor to UL corner (negative = up)
} GFXglyph;
...
// ── Font constants ─────────────────────────────────────────────────────────────
#define DPX_FONT_H          5    // Glyph height in pixels
#define DPX_FONT_BASELINE   6    // cursor_y to center glyph in 8-row display
